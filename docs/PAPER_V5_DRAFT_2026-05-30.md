...
### 5.3 Cross-quantization sanity ((paper v1: Q2_K vs Q4_K_M))
...
- exp166 ((4 patch × 4 prompt × 32 seeds = 512 runs, pre-registered, in progress)) — statistical confirmation or refutation of Hypothesis B+
...
- TBD ((D-1 想 定)): exp167 full-bench L25/L26 alone results ((running))
- TBD: cross-model replication results
- TBD: logit-lens / activation patching for direct mechanism observation
