...
背景:
  mimir_odin は 4 specialist 並列で弱点を相互補完するが、高次元多峰問題では
...
Hierarchy: Council で次元圧縮 → Cardinal (汎用 GA) で進化探索
  Step 1 (20% budget): mimir_odin で structure_only、active_dims を抽出
...
def mimir_cardinal_hierarchy(
    ...
    *,
    ...
    Step 1: mimir_odin(mode="structure_only") で active_dims 抽出
